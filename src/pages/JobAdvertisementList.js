...
import { Item, Label, Container, Icon, Grid } from 'semantic-ui-react'
...
export default function JobAdvertisementList() {
  ...
  return (
    <div className='jobAdvertisements'>
      <Container>
        <Grid >
          <Grid.Column className='jobAdvertisement'>
            <Item.Group divided>
              {
                  ...
                  <Item key={jobAdvertisement.id}>
                    ...
                    <Item.Content>
                      ...
                      <Item.Extra>
                        ...
                        <Label as='a' basic color='green'>Yayınlanma Tarihi : {jobAdvertisement.updatedAt}</Label><br />
